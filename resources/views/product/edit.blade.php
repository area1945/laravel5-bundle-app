        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form id="form-submit" autocomplete="off" class="form-horizontal" method="POST" action="{{ route('product.update', ['id'=> $model->id]) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{  method_field('PATCH')  }}
                            ...
                            <div class="col-md-6">
                                <select id="categories" name="categories[]" class="select2" style="width:100%;"  multiple required>
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ in_array($category->id, $products_categories) ? 'selected' : '' }} >{{ $category->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input placeholder="Masukan Harga" id="price" type="number" class="form-control" name="price" value="{{ (float)$model->price  }}" required>
                        ...
                        <div class="form-group{{ $errors->has('stock') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input placeholder="Masukan Stok" id="stock" type="number" class="form-control" name="stock" value="{{ (int)$model->stock  }}" required>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea placeholder="Masukan Deskripsi" class="form-control" name="description" id="description" rows="4" required>{{ $model->description  }}</textarea>
